          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button 
                ...
                className="px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-xl font-semibold transition-all shadow-md hover:shadow-lg flex items-center justify-center space-x-2"
              >
              ...
              <button className="px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-semibold transition-colors shadow-md hover:shadow-lg">
                Agregar comida
              </button>
            </div>
          </div>
